rm(list = ls(all=T))
setwd("D:/NATURALIS/R_Data/")
# save(list=ls(all=TRUE), file="D:/NATURALIS/R_Data/BGE_gap.RData") # save RDATA for later use
load("D:/NATURALIS/R_Data/BGE_gap.RData")
...
countries <- sf::st_read("D:/NATURALIS/GIS_Data/ne_50m_admin_1_states_provinces")
countries <- geojson_read("D:/NATURALIS/GIS_Data/ref-countries-2020-60m.geojson/CNTR_BN_60M_2020_3035.geojson")
str(countries)
